...
namespace Sistema.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaID,Nombre,Descripcion,Eestado")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaID,Nombre,Descripcion,Eestado")] Categoria categoria)
        {
